...
# 3.a - sa se scrie o functie care primeste ca parametru o lista de vehicule
# si apeleaza fuctia ride() pentu fiecare
...
# 3.b - sa se scrie o functie care returneaza toate vehiculele cu o capacitate de mai mult de 2 persoane
...
# 3.c - sa se scrie o functie care returneaza toate numele persoanelor care detin o Bike
